...
# A cada dia mais perto da sua festa, alguns amigos ainda estão meio noiados com a transmissão do virus (e não é para menos com tantas variantes de depois de tantos mortos). Seu amigo João é um deles. Infelizmente ele pediu para ser retirado da lista. Remova o João a Lista

#primeira maneira de fazer
listaConvidados.remove('João')
print("Removendo o João")
print(listaConvidados)

listaConvidados.append('João')
print(listaConvidados)
indice = listaConvidados.index('João')
print(indice)
listaConvidados.pop(indice)
print("Removendo o João")
print(listaConvidados)